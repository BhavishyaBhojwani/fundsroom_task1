...
(function($) {
	...
	const propertyData = {
		'property1': {
			id: 'property1',
			title: '4BHK Perfectly Crafted Villas',
		...
		'property2': {
			id: 'property2',
			title: '4BR 2H 2K Garden Apartments',
		...
		'property3': {
			id: 'property3',
			title: '4B2HK Flats & 5B2HK Penthouses',
		...
		'property4': {
			id: 'property4',
			title: 'Modern Office Space with Parking',
		...
		'property5': {
			id: 'property5',
			title: 'Prime Retail Shop in Mall',
		...
		'property6': {
			id: 'property6',
			title: 'Large Warehouse with Loading Bay',
